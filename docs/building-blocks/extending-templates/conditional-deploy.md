...
<span data-ttu-id="7e3ff-113">テンプレートの各セクションを見てみましょう。</span><span class="sxs-lookup"><span data-stu-id="7e3ff-113">Let's take a look at each section of the template.</span></span>
