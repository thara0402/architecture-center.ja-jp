...
## <a name="availability-considerations---traffic-manager"></a>可用性に関する考慮事項 - Traffic Manager
...
## <a name="availability-considerations---sql-database"></a>可用性に関する考慮事項 - SQL Database

「[Azure SQL データベースによるビジネス継続性の概要][sql-rpo]」に、SQL Database の目標復旧時点 (RPO) と推定復旧時間 (ERT) の説明があります。

## <a name="availability-considerations---storage"></a>可用性に関する考慮事項 - ストレージ
...
## <a name="manageability-considerations---traffic-manager"></a>管理容易性に関する考慮事項 - Traffic Manager
...
## <a name="manageability-considerations---sql-database"></a>管理容易性に関する考慮事項 - SQL Database
