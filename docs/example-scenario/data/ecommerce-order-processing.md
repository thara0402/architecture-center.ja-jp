...
[Cosmos DB セキュリティ モデル](/azure/cosmos-db/secure-access-to-data)では、ユーザーを認証し、そのデータとリソースへのアクセスを提供しています。 詳細については、[Cosmos DB のデータ セキュリティ](/en-us/azure/cosmos-db/database-security)に関するページをご覧ください。
...
* [Azure データ アーキテクチャ ガイド](/azure/architecture/data-guide/)の[リアルタイム処理アーキテクチャ](/azure/architecture/data-guide/big-data/real-time-processing)
