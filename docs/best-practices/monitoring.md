...
詳細については、「 [Azure: Telemetry Basics and Troubleshooting (Azure: 製品利用統計情報の基本とトラブルシューティング)」](https://social.technet.microsoft.com/wiki/contents/articles/18146.windows-azure-telemetry-basics-and-troubleshooting.aspx)を参照してください。
...
* [Azure: Telemetry Basics and Troubleshooting (Azure: 製品利用統計情報の基本とトラブルシューティング)](https://social.technet.microsoft.com/wiki/contents/articles/18146.windows-azure-telemetry-basics-and-troubleshooting.aspx)
